...
BLOG_AUTHOR = "katze"  # (translatable)
BLOG_TITLE = "kunfoose Gedankenfetzen"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://kunfoo.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://kunfoo.org/"
BLOG_EMAIL = "katze@kunfoo.org"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        ("/rss.xml", "RSS-Feed"),
        ("/pages/fahrrad-foo/", "Fahrrad"),
        ("/pages/eine-neue-seite/", "Seite Foo"),
    ),
}
...
CONTENT_FOOTER = '<a href="mailto:{email}">{author}</a> - CC BY-NC-SA'
